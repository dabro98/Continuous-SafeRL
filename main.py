...
class TensorboardCallback(BaseCallback):
    ...
    def __init__(self, critical_area_reward, log_std_init,
                n_steps, n_epochs, env_name, verbose=1):
...
def main():
    ...
    adv_model_name = "models/PPO/t2/2023-09-30_23:11:44_9.zip"
